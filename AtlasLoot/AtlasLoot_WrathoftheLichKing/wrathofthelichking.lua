...
---- Emblem of Frost Items
	...
	AtlasLoot_Data["Naxx80HM3"] = {
		...
		{ 12, 3534, "", "=q4=", "=ds=#s9#, #a4#",};
		{ 13, 94, "", "=q4=", "=ds=#s10#, #a4#",};
		{ 14, 1398, "", "=q4=", "=ds=#s11#, #a4#",};
		{ 15, 1174, "", "=q4=", "=ds=#s12#, #a4#",};
		
		{ 16, 1026, "", "=q4=", "=ds=#s1#, #a4#"};
		{ 17, 3226, "", "=q4=", "=ds=#s3#, #a4#"};
		{ 18, 2952, "", "=q4=", "=ds=#s5#, #a4#"};
		{ 19, 13729, "", "=q4=", "=ds=#s9#, #a4#",};
		{ 20, 146, "", "=q4=", "=ds=#s10#, #a4#",};
		{ 21, 4574, "", "=q4=", "=ds=#s11#, #a4#",};
		{ 22, 2107, "", "=q4=", "=ds=#s12#, #a4#",};
		
		{ 24, 1272, "", "=q4=", "=ds=#s3#, #a4#"};----------------
		{ 25, 3526, "", "=q4=", "=ds=#s9#, #a4#",}; ---------------
		{ 26, 90, "", "=q4=", "=ds=#s10#, #a4#",}; ----------------
		{ 27, 1397, "", "=q4=", "=ds=#s11#, #a4#",}; ---------------
		{ 28, 136, "", "=q4=", "=ds=#s12#, #a4#",};
	...
	AtlasLoot_Data["Naxx80HM4"] = {
		...
		{ 10, 30699, "", "=q4=", "=ds=#h1#, #w1#"};
		{ 11, 33975, "", "=q4=", "=ds=#h1#, #w13#"};
		
		{ 13, 39753, "", "=q4=", "=ds=#h2#, #w6#"};
		{ 14, 28165, "", "=q4=", "=ds=#w5#", ""};
		{ 15, 43092, "", "=q4=", "=ds=#w8#", ""};
		
		{ 16, 1897, "", "=q4=", "=ds=#h1#, #w10#",};
		{ 17, 32425, "", "=q4=", "=ds=#h1#, #w10#",};
		{ 18, 32484, "", "=q4=", "=ds=#h3#, #w10#",};
		{ 19, 34682, "", "=q4=", "=ds=#h1#, #w10#",};
		{ 20, 34879, "", "=q4=", "=ds=#h1#, #w10#",};
		{ 21, 39754, "", "=q4=", "=ds=#h1#, #w10#",};
		{ 22, 40553, "", "=q4=", "=ds=#h1#, #w10#",};
		{ 23, 43091, "", "=q4=", "=ds=#h1#, #w10#",};
		{ 24, 44238, "", "=q4=", "=ds=#h3#, #w10#",};
		{ 25, 44439, "", "=q4=", "=ds=#h3#, #w10#",};
	
		{ 27, 41259, "", "=q4=", "=ds=#h2#, #w10#"};
		{ 28, 42478, "", "=q4=", "=ds=#h2#, #w10#"};
		{ 29, 43692, "", "=q4=", "=ds=#h2#, #w10#"};

		Prev = "Naxx80HM3";
		Next = "Naxx80HM5";
	};
	
	AtlasLoot_Data["Naxx80HM5"] = {
		{ 1, 0, "achievement_dungeon_naxxramas_10man", "=q6=" ..AL["Available in 25-man only"]};
		{ 2, 13711, "", "=q4=", "=ds=#s6#"};
		{ 3, 13712, "", "=q4=", "=ds=#s6#"};
		{ 4, 13713, "", "=q4=", "=ds=#s6#"};
		{ 5, 13714, "", "=q4=", "=ds=#s6#"};
		...
		{ 17, 17343, "", "=q4=", "=ds=#s6#"};
		{ 18, 19844, "", "=q4=", "=ds=#s6#"};
		{ 20, 44885, "", "=q4=Black Fly Qiraji Resonating Crystal", "=ds=#e12#", ""};
	...
	--=====================================
		...
		{ 16, 3059, "", "=q4=", "=ds=#s1#, #a1#"};
		{ 17, 2655, "", "=q4=", "=ds=#s3#, #a1#"};
		{ 18, 12187, "", "=q4=", "=ds=#s5#, #a1#"};
		{ 19, 3540, "", "=q4=", "=ds=#s11#, #a1#"};
		{ 20, 3896, "", "=q4=", "=ds=#s12#, #a1#"};
		
		{ 22, 1545, "", "=q4=", "=ds=#s3#, #a1#"};
		{ 23, 3538, "", "=q4=", "=ds=#s5#, #a1#"};
		{ 24, 5295, "", "=q4=", "=ds=#s9#, #a1#"};
		{ 25, 3523, "", "=q4=", "=ds=#s11#, #a1#"};
		{ 26, 3533, "", "=q4=", "=ds=#s12#, #a1#"};
		
		Prev = "ICCTrash25Man";
		Next = "ICCMythic2";
	};
	
	AtlasLoot_Data["ICCMythic2"] = {
		{ 1, 2994, "", "=q4=", "=ds=#s1#, #a2#"};
		{ 2, 2647, "", "=q4=", "=ds=#s3#, #a2#"};	
		{ 3, 10006, "", "=q4=", "=ds=#s5#, #a2#"};	
		{ 4, 3546, "", "=q4=", "=ds=#s8#, #a2#"};	
		...
		{ 12, 3537, "", "=q4=", "=ds=#s5#, #a2#"};
		{ 13, 5294, "", "=q4=", "=ds=#s9#, #a2#"};
		{ 14, 3243, "", "=q4=", "=ds=#s11#, #a2#"};
		{ 15, 3524, "", "=q4=", "=ds=#s12#, #a2#"};
		...
		{ 20, 3549, "", "=q4=", "=ds=#s9#, #a3#"};
		{ 21, 102, "", "=q4=", "=ds=#s10#, #a3#"};
		{ 22, 3050, "", "=q4=", "=ds=#s11#, #a3#"};
		{ 23, 3060, "", "=q4=", "=ds=#s12#, #a3#"};
	...
	AtlasLoot_Data["ICCMythic3"] = {
		...
		{ 12, 3547, "", "=q4=", "=ds=#s5#, #a4#"};
		{ 13, 5296, "", "=q4=", "=ds=#s9#, #a4#"};
		{ 14, 3532, "", "=q4=", "=ds=#s11#, #a4#"};
		{ 15, 3541, "", "=q4=", "=ds=#s12#, #a4#"};	
		
		{ 16, 3007, "", "=q4=", "=ds=#s3#, #a4#"};
		{ 17, 12188, "", "=q4=", "=ds=#s5#, #a4#"};
		{ 18, 3646, "", "=q4=", "=ds=#s8#, #a4#"};
		{ 19, 5298, "", "=q4=", "=ds=#s9#, #a4#"};
		{ 20, 126, "", "=q4=", "=ds=#s10#, #a4#"};
		{ 21, 3548, "", "=q4=", "=ds=#s11#, #a4#"};
		{ 22, 4195, "", "=q4=", "=ds=#s12#, #a4#"};	
	...
	AtlasLoot_Data["ICCMythic4"] = {
	{ 1, 3364, "", "=q4=", "=ds=#h1#, #w10#",};
	{ 2, 2179, "", "=q4=", "=ds=#h1#, #w10#",};
	{ 3, 2180, "", "=q4=", "=ds=#h1#, #w10#",};
	{ 4, 42933, "", "=q4=", "=ds=#h1#, #w10#",};
	{ 5, 43221, "", "=q4=", "=ds=#h1#, #w10#",};
	...
	{ 16, 43479, "", "=q4=", "=ds=#h1#, #w4#"};
	{ 17, 43598, "", "=q4=", "=ds=#h1#, #w4#"};
