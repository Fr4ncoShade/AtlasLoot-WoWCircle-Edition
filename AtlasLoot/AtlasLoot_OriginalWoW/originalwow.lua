...
---- Azuregos
	...
	AtlasLoot_Data["ZFTimewalking"] = {
		{ 1, 53491, "", "=q4=Twilight Offering Bands", "=ds=#s8#, #a4#", "", "20.00%"},   -- запястья, латы (s8 = запястья, a4 = латы)
		{ 2, 53492, "", "=q4=Ring of the Three-Headed Beast", "=ds=#s13#", "", "20.00%"},   -- палец (s13 = кольцо)
		{ 3, 53493, "", "=q4=Sacrificial Mail", "=ds=#s11#, #a4#", "", "20.00%"},           -- ноги, кольчуга (s11 = ноги, a4 = латы)
		{ 4, 53494, "", "=q4=Girdle of Oblation", "=ds=#s10#, #a3#", "", "20.00%"},          -- пояс, латы (s10 = пояс, a3 = латы)
		{ 5, 53495, "", "=q4=Old Gods' Blessing", "=ds=#s13#", "", "20.00%"},                -- кольцо (s13 = кольцо)
	};
