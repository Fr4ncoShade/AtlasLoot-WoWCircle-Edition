...
-----------------------
  ...
  -- Naxxramas Level 80
	...
	--AtlasLoot_TableNames["Naxx80HM"] = { AL["NaxxHM"].." ("..BabbleZone["Naxxramas"]..")", "AtlasLootWotLK" };
	AtlasLoot_TableNames["Naxx80HM1"] = { AL["NaxxHM"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Naxx80HM2"] = { AL["NaxxHM"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Naxx80HM3"] = { AL["NaxxHM"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Naxx80HM4"] = { AL["NaxxHM"], "AtlasLootWotLK" };
	AtlasLoot_TableNames["Naxx80HM5"] = { AL["NaxxHM"], "AtlasLootWotLK" };
  ...
  -- Icecrown Citadel
	...
	AtlasLoot_TableNames["ICCTrash25Man"] = { AL["Trash Mobs"].." ("..BabbleZone["Icecrown Citadel"]..")", "AtlasLootWotLK" };
		AtlasLoot_TableNames["ICCMythic1"] = { AL["Mythic"], "AtlasLootWotLK" };
		AtlasLoot_TableNames["ICCMythic2"] = { AL["Mythic"], "AtlasLootWotLK" };
		AtlasLoot_TableNames["ICCMythic3"] = { AL["Mythic"], "AtlasLootWotLK" };
		AtlasLoot_TableNames["ICCMythic4"] = { AL["Mythic"], "AtlasLootWotLK" };
...
-------------------------
  ...
  -- Zul'Farrak
	...
	AtlasLoot_TableNames["ZFTimewalking"] = { "Timewalking", "AtlasLootOriginalWoW" };
  -- Zul'Gurub
